...
export default function TeacherApp({ onLogout, data, actions }) {
  ...
  return (
    <div className="app fi">
      {tab === "today"   && <TeacherToday    {...sharedProps}/>} 
      {tab === "attend"  && <TeacherAttend   {...sharedProps}/>} 
      {tab === "plan"    && <TeacherPlan     {...sharedProps}/>} 
      {tab === "notes"   && <TeacherNotes    {...sharedProps}/>} 
