...
export default function ParentToday({ onLogout, childrenList, selectedChild, selectedChildId, onSelectChild }) {
  ...
  return (
    <div className="scroll-top">
      ...
      <div className="child-band" style={{background:`linear-gradient(135deg,${selectedChild.accent},${selectedChild.accent2})`}}>
        <div className="child-avatar-lg" aria-hidden="true">{selectedChild.avatar}</div>
        <div style={{flex:1}}>
          ...
          <div className="row" style={{gap:8,marginTop:4,flexWrap:"wrap"}}>
            <span className="tag tag-sky">{selectedChild.className}</span>
            <span className="tag tag-sage" style={{background:"#D8F5D0",color:"#5A9048"}}>✓ {selectedChild.status}</span>
      ...
      <div className="card">
        <div className="row-between" style={{marginBottom:12}}>
          <div>
            ...
            <p style={{fontSize:11,color:"#ABA099",fontWeight:700,marginTop:2}}>{selectedChild.className} · {selectedChild.teacher}</p>
          </div>
      ...
      <div className="card">
        <div className="sec-header">
          <div>
            ...
            <p style={{fontSize:11,color:"#ABA099",fontWeight:700,marginTop:2}}>Filtered for {selectedChild.shortName}</p>
          </div>
      ...
      <div className="note-preview">
        ...
        <p style={{fontSize:11,color:"#ABA099",marginTop:8,fontWeight:600}}>— {selectedChild.teacher}, Today</p>
      </div>
